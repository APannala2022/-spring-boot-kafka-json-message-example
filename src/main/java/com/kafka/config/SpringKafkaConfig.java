...
public class SpringKafkaConfig {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, Space> kafkaListenerContainerFactory() {
		ConcurrentKafkaListenerContainerFactory<String, Space> factory = new ConcurrentKafkaListenerContainerFactory<String, Space>();
